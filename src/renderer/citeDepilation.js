...
const createCiteDepilation = document.getElementById("createCiteDepilation");
...
createCiteDepilation.addEventListener("submit", (e) => {
...
ipcRenderer.on("procedures-depilation", (event, args) => {
...
ipcRenderer.send("get-procedures-depilation");
